...
import com.dm.danmu.HttpRequestHandler;
import com.dm.danmu.TextWebSocketFrameServerHandler;
...
public class WebsocketDanmuServerInitializer extends
    ...
    public void initChannel(SocketChannel ch) throws Exception {//2
		...
		*/
		...
		pipeline.addLast("WebSocket-request",new TextWebSocketFrameServerHandler());
